...
{
    [ApiController]
    //dependencia: un comentario depende de un libro
    ...
    public class ComentariosController : ControllerBase
    {
        ...
        [HttpGet(Name = "obtenerComentarioLibroV2")]
        [AllowAnonymous]
        ...
        public async Task<ActionResult> Post(int libroId, ComentarioCreacionDTO comentarioCreacionDTO)
        {
            ...
            return CreatedAtRoute("obtenerComentarioV2", new { id = comentario.Id, libroId = comentario.LibroId }, comentarioDTO);
        }
